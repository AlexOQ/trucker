 ...
 *
 * Renders individual city details: fleet recommendations, export buttons,
 * garage toggle, and city stats. Extracted from main.ts.
 */

import { computeFleetAsync, computeRankingsAsync } from './optimizer-client.js';
import type { OptimalFleetEntry } from './optimizer.js';
import {
...
import type { MainState, ScoreTier } from './rankings-view.js';
import { getScoreTier, updateGarageCount } from './rankings-view.js';
...
function getCityRank(cityId: string, displayedRankings: MainState['displayedRankings']) {
